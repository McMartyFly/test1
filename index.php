                    ...
                    <ul class="list">
                        <li>
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <a class="button">Light</a>
                                </li>
                                <li>
                                    <a class="button">Mage Hand</a>
                                </li>
                                <li>
                                    <a class="button">Mending</a>
                                </li>
                                <li>
                                    <a class="button">Message</a>
                                </li>
                                <li>
                                    <a class="button">Minor Illusion</a>
                                </li>
                                <li>
                                    <a class="button">Poison Spray</a>
                                </li>
                                <li>
                                    <a class="button">Prestidigitation</a>
                                </li>
                                <li>
                                    <a class="button">Ray of Frost</a>
                                </li>
                                <li>
                                    <a class="button">Shocking Grasp</a>
                                </li>
                                <li>
                                    <a class="button">True Strike</a>
                                </li>
                            </ul>
                        </li>
                        <li>
